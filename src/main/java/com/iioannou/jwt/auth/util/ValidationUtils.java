...
public interface ValidationUtils {
    ...
    /**
     * Checks that the specified char sequence is not {@code null} or empty and throws a customized {@link NullPointerException} respectively {@link
     * IllegalArgumentException} if it is.
     *
     * @param <T>
     * @param charSequence    the char sequence to check
     * @param messageSupplier supplier of the detail message to be used in the event that a exception is thrown
    ...
    /**
     * Checks that the specified char sequence is not {@code null} or blank and throws a customized {@link NullPointerException} respectively {@link
     * IllegalArgumentException} if it is.
     *
     * @param <T>
     * @param charSequence    the char sequence to check
    ...
    /**
     * Checks that the specified collection is not {@code null} or empty and throws a customized {@link NullPointerException} respectively {@link
     * IllegalArgumentException} if it is.
     *
     * @param <T>
    ...
    /**
     * Checks that the specified value is greater than zero and throws a customized {@link IllegalArgumentException} if it isn't.
     *
    ...
    /**
     * Checks that the specified value is greater or equal than zero and throws a customized {@link IllegalArgumentException} if it isn't.
     *
     * @param value           the value to check
     * @param messageSupplier supplier of the detail message to be used in the event that a exception is thrown
